...
import { Image as ImageView, View, ScrollView, Text, StyleSheet, Dimensions, Linking } from 'react-native';
      ...
      <View style={styles.imagesContainer}>
        <ScrollView horizontal pagingEnabled>
          { orphanage.images.map(image => {
            return (
              <ImageView key={image.id} style={styles.image} source={{ uri: image.url }} />
            )
          }) }
        </ScrollView>
      </View>
        ...
        <View style={styles.scheduleContainer}>
          ...
          { orphanage.open_on_weekends ? (
            ...
            <View style={[styles.scheduleItem, styles.scheduleItemRed]}>
              <Feather name="info" size={40} color="#F32e5a" />
